    ...
    switch (type) {
        ...
        case SHAPE_TYPE.RECT_MINUS_SINGLE_ANGLE: {
            ...
            path = `M${rect.maxX} ${rect.minY + len}V${rect.maxY}H${
                rect.minX
            }V${rect.minY}H${rect.maxX - len}L${rect.maxX} ${rect.minY + len}Z`;
            break;
        }
        ...
        case SHAPE_TYPE.RECT_MINUS_OPPOSITE_ANGLE: {
            ...
            path = `M${rect.maxX} ${rect.minY + len}V${rect.maxY}H${
                rect.minX + len
            }L${rect.minX} ${rect.maxY - len}V${rect.minY}H${rect.maxX - len}L${
                rect.maxX
            } ${rect.minY + len}Z`;
            break;
        }
        case SHAPE_TYPE.RECT_SINGLE_RADIUS_MINUS_SINGLE_ANGLE: {
            ...
            path = `M${rect.maxX} ${rect.minY + len}V${rect.maxY}H${
                ...
                rect.minX + radius
            } ${rect.minY}H${rect.maxX - len}L${rect.maxX} ${rect.minY + len}Z`;
            break;
        }
        ...
        case SHAPE_TYPE.PARALLELOGRAM: {
            ...
            path = `M ${rect.minX + offsetX} ${rect.minY} L ${rect.maxX} ${
                rect.minY
            } L ${rect.maxX - offsetX} ${rect.maxY} L ${rect.minX} ${
                rect.maxY
            } Z`;
            break;
        }
        case SHAPE_TYPE.TRAPEZOIDAL: {
            const offsetX = (width / 2) * 0.3;
            path = `M ${rect.minX + offsetX} ${rect.minY} L ${
                rect.maxX - offsetX
            } ${rect.minY} L ${rect.maxX} ${rect.maxY} L ${rect.minX} ${
                rect.maxY
            } Z`;
            break;
        }
        ...
        case SHAPE_TYPE.PENTAGON: {
            ...
            const sx = (rect.minX + rect.maxX) / 2;
            path = `M ${sx} ${rect.minY} L ${rect.maxX} ${
                rect.minY + offsetY
            } L ${rect.maxX - offsetX} ${rect.maxY} L ${rect.minX + offsetX} ${
                rect.maxY
            } L ${rect.minX} ${rect.minY + offsetY} Z`;
            break;
        }
        case SHAPE_TYPE.HEXAGON: {
            ...
            path = `M ${rect.minX + offsetX} ${rect.minY} L ${
                rect.maxX - offsetX
            } ${rect.minY} L ${rect.maxX} ${sy} L ${rect.maxX - offsetX} ${
                rect.maxY
            } L ${rect.minX + offsetX} ${rect.maxY} L ${rect.minX} ${sy} Z`;
            break;
        }
        case SHAPE_TYPE.HEPTAGON: {
            ...
            path = `M ${ax + rect.minX} ${ay + rect.minY} L ${cx} ${
                rect.minY
            } L ${rect.maxX - ax} ${ay + rect.minY} L ${rect.maxX} ${
                by + rect.minY
            } L ${rect.maxX - dx} ${rect.maxY} L ${rect.minX + dx} ${
                rect.maxY
            } L ${rect.minX} ${by + rect.minY} Z`;
            break;
        }
        case SHAPE_TYPE.OCTAGON: {
            const x = 0.295 * width;
            const y = 0.295 * height;
            path = `M ${x + rect.minX} ${rect.minY} L ${rect.maxX - x} ${
                rect.minY
            } L ${rect.maxX} ${rect.minY + y} L ${rect.maxX} ${
                rect.maxX - y
            } L ${rect.maxX - x} ${rect.maxY} L ${rect.minX + x} ${
                rect.maxY
            } L ${rect.minX} ${rect.maxY - y} L ${rect.minX} ${
                rect.minY + y
            } Z`;
            break;
        }
        case SHAPE_TYPE.DECAGON: {
            ...
            path = `M ${x + rect.minX} ${y + rect.minY} L ${tx} ${
                rect.minY
            } L ${tx + lw} ${rect.minY} L ${rect.maxX - x} ${rect.minY + y} L ${
                rect.maxX
            } ${(rect.maxY + rect.minY) / 2} L ${rect.maxX - x} ${
                rect.maxY - y
            } L ${tx + lw} ${rect.maxY} L ${tx} ${rect.maxY} L ${
                rect.minX + x
            } ${rect.maxY - y} L ${rect.minX} ${(rect.maxY + rect.minY) / 2} Z`;
            break;
        }
        case SHAPE_TYPE.DODECAGON: {
            ...
            path = `M ${x + rect.minX} ${y + rect.minY} L ${tx} ${
                ...
                rect.maxX
            } ${ty} L ${rect.maxX} ${ty + lh} L ${rect.maxX - x} ${
                rect.maxY - y
            } L ${tx + lw} ${rect.maxY} L ${tx} ${rect.maxY} L ${
                rect.minX + x
            } ${rect.maxY - y} L ${rect.minX} ${ty + lh} L ${
                rect.minX
            } ${ty} Z`;
            break;
        }
        ...
        case SHAPE_TYPE.FRAME_SHAPE: {
            const bw = width * 0.15;
            path = `M ${rect.minX} ${rect.minY} L ${rect.maxX} ${rect.minY} L ${
                rect.maxX
            } ${rect.maxY} L ${rect.minX} ${rect.maxY} Z M ${rect.minX + bw} ${
                rect.minY + bw
            } L ${rect.minX + bw} ${rect.maxY - bw} L ${rect.maxX - bw} ${
                rect.maxY - bw
            } L ${rect.maxX - bw} ${rect.minY + bw} Z`;
            break;
        }
        case SHAPE_TYPE.HALF_CLOSED_FRAME_SHAPE: {
            ...
            path = `M ${rect.minX} ${rect.minY} L ${rect.maxX} ${rect.minY} L ${
                rect.maxX - iw
            } ${rect.minY + bw} L ${rect.minX + bw} ${rect.minY + bw} L ${
                rect.minX + bw
            } ${rect.maxY - ih} L ${rect.minX} ${rect.maxY} Z`;
            break;
        }
        case SHAPE_TYPE.HORN: {
            const bw = Math.min(width, height) * 0.4;
            path = `M ${rect.minX} ${rect.minY} L ${rect.minX + bw} ${
                rect.minY
            } L ${rect.minX + bw} ${rect.maxY - bw} L ${rect.maxX} ${
                rect.maxY - bw
            } L ${rect.maxX} ${rect.maxY} L ${rect.minX} ${rect.maxY} Z`;
            break;
        }
        case SHAPE_TYPE.TWILL: {
            const wx = width * 0.5;
            const hy = height * 0.5;
            path = `M ${rect.minX + wx} ${rect.minY} L ${rect.maxX} ${
                rect.minY
            } L ${rect.minX} ${rect.maxY} L ${rect.minX} ${rect.maxY - hy} Z`;
            break;
        }
        case SHAPE_TYPE.CROSS: {
            const a = Math.min(width, height) * 0.25;
            path = `M ${rect.minX + a} ${rect.minY} L ${rect.maxX - a} ${
                rect.minY
            } L ${rect.maxX - a} ${rect.minY + a} L ${rect.maxX} ${
                rect.minY + a
            } L ${rect.maxX} ${rect.maxY - a} L ${rect.maxX - a} ${
                rect.maxY - a
            } L ${rect.maxX - a} ${rect.maxY} L ${rect.minX + a} ${
                rect.maxY
            } L ${rect.minX + a} ${rect.maxY - a} L ${rect.minX} ${
                rect.maxY - a
            } L ${rect.minX} ${rect.minY + a} L ${rect.minX + a} ${
                rect.minY + a
            } Z`;
            break;
        }
        case SHAPE_TYPE.CUTAWAY_RECTANGLE: {
            ...
            path = `M ${rect.minX + r} ${rect.minY} L ${rect.maxX - r} ${
                rect.minY
            } A ${r} ${r} 90 0 0 ${rect.maxX} ${rect.minY + r} L ${rect.maxX} ${
                rect.minY + r
            } L ${rect.maxX} ${rect.maxY - r} A ${r} ${r} 90 0 0 ${
                rect.maxX - r
            } ${rect.maxY} L ${rect.minX + r} ${rect.maxY} A ${r} ${r} 90 0 0 ${
                rect.minX
            } ${rect.maxY - r} L ${rect.minX} ${
                rect.minY + r
            } A ${r} ${r} 90 0 0 ${rect.minX + r} ${rect.minY} Z`;
            break;
        }
        case SHAPE_TYPE.RING: {
            ...
            const cx = (rect.minX + rect.maxX) / 2;
            path = `M ${cx} ${rect.minY} A ${rx} ${ry} 180 0 0 ${cx} ${
                rect.maxY
            } A ${rx} ${ry} 180 0 0 ${cx} ${rect.minY} M ${cx} ${
                rect.minY + rb
            } A ${rx - rb} ${ry - rb} 180 0 1 ${cx} ${rect.maxY - rb} A ${
                rx - rb
            } ${ry - rb} 180 0 1 ${cx} ${rect.minY + rb} Z`;
            break;
        }
    }
    return !needPathString && canvas ? new Path2D(canvas, path) : path;
};
